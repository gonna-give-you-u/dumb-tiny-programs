...
**tagsearch:** searches a specified 'taglist' file (or stdin) with a certain syntax for paths with certain tags assigned to them. probably the most useful of these programs. first version is зроблена ў беларусі, improved in the uk after 8 months of laziness<br>
